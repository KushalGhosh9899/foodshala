...
if (isset($_POST['search-query'])) {
    $searchValue = $_POST['search-query'];
}
elseif(isset($_GET['pname'])){
    $searchValue = $_GET['pname'];
} 
else {
                            ...
                            <div class="sort-box d-flex justify-content-between align-items-md-center align-items-start flex-md-row flex-column" data-aos="fade-up" data-aos-delay="0">
                                ...
                                <div class="sort-tablist d-flex align-items-center">
                                    ...
                                    <div class="page-amount ml-2">
                                        <span>Showing all results for all Dishes</span>
                                    </div> <!-- End Page Amount -->
                                ...
                                <div class="sort-select-list d-flex align-items-center">
                                    ...
                                    <select class="form-control" onchange="window.location.href=`search-product?filter-product=${value}&pname=<?php echo $searchValue;?>`">
                                    ...
                                    <div class="tab-pane active show sort-layout-single" id="layout-4-grid">
                                        <div class="row">
                                            ...
                                            if (!empty($_GET['filter-product'])) {
                                                ...
                                                $searchquery=$_GET['pname'];
                                                $sql = "SELECT * FROM products where productName LIKE '%$searchquery%' OR foodType LIKE '%$searchquery%' OR price LIKE '%$searchquery%' OR description LIKE '%$searchquery%' OR restaurantName LIKE '%$searchquery%' ORDER BY price $filter";
                                                ...
                                                $sql = "SELECT * FROM products where productName LIKE '%$searchquery%' OR foodType LIKE '%$searchquery%' OR price LIKE '%$searchquery%' OR description LIKE '%$searchquery%' OR restaurantName LIKE '%$searchquery%'";
                                                $result = $conn->query($sql);
                                                if ($conn) {
                                                    if ($result->num_rows > 0) {
                                                        while ($row = $result->fetch_assoc()) {
